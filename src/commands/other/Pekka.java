 ...
 * {@link EmbedManager#help(CommandEvent, java.util.Collection)}, passing
 * the live command registry pulled from
...
public class Pekka extends Command {
    ...
    protected void execute(CommandEvent event) {
        EmbedManager.help(event, event.getClient().getCommands());
    }
}
